...
public class AlphaCheckBox extends AppCompatCheckBox {
    ...
    public AlphaCheckBox(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AlphaCheckBox(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
