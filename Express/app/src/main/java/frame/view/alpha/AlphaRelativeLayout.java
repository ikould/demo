...
public class AlphaRelativeLayout extends RelativeLayout {
    ...
    public AlphaRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AlphaRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
