...
public class AlphaRadioButton extends AppCompatRadioButton {
    ...
    public AlphaRadioButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AlphaRadioButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
